...
\usepackage{import} % for subimport each proj
...
%%-- This is how to set Arial font using LaTeX/PdfLaTeX -- Shanhe
...
\thesisCommittee[Computer Science]{Professor A}{The College of William and Mary}
\thesisCommittee[Computer Science]{Professor B}{The College of William and Mary}
\thesisCommittee[Computer Science]{Professor C}{The College of William and Mary}
\thesisCommittee[Electrical and Computer Engineering]{Professor D}{The College of William and Mary}
